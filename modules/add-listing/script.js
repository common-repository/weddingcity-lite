...
(function($) {
  ...
  'use strict';
     ...
     */
    if( $('form#vendor-add-listing').length ){

        // @ref : Multiple checkboxes - http://jsfiddle.net/4kwnR/16/

        $('form#vendor-add-listing').on('submit', function(e){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'action'                : 'weddingcity_add_listing_action',
                    'security'              : $( form_id +' #vendor_add_listing').val(),
    ...
    function WeddingCity_Listing_Front_End_InitMap() {
        ...
        _lat     =  parseFloat( WeddingCity_AJAX_OBJECT.weddingcity_latitude ),
        _lng     =  parseFloat( WeddingCity_AJAX_OBJECT.weddingcity_longitude ),
